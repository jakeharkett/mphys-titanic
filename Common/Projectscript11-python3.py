...
"""
RECENTERING LOOP FUNCTION
"""
def RecenteringLoop(cube, name_input):
	return 0
...
while Centring_loop == 0:
	...
	------ 3 - REMOVE BAD IMAGES
	"""
	print( "Would you like to remove any image? \n {name}_filenames.txt will be updated if you do".format(name = name_input) )
	...
	RecenteringLoop(cube, name_input)
...
print( " A reference point is any spherical bright point in the image (candidates, speckles, etc)")
...
#RunLLSG(cube, angs, fwhm, name_input)
